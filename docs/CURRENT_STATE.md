...
**Last Updated:** July 18, 2026 (Sprint 6 released as `v0.7.0-alpha`; post-Sprint-6 governance restructuring complete; Sprint 7 "First Demonstrable Product" Kickoff written, CTO go-ahead granted, branch created, Commits 1-8 done — Commit 8 wired the real format/layout selector)
...
**Branch:** `feature/sprint-7-first-demonstrable-product`, at `1e5b392` (Commit 8: format/layout selector; this docs-sync commit follows immediately on top), branched from `main` at `31b3139`, tag `v0.7.0-alpha`.
