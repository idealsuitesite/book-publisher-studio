...
**Last Updated:** July 18, 2026 — **Sprint 8 ("Publishing Engine") released as `v0.9.0-alpha`** (PR #13 merged, merge commit `4a4deaa`, tag pushed). Work now happens on `main` — there is no active feature branch.
