...
>
> **Branch:** `feature/sprint-9-ui-foundation`, working tree clean, everything pushed. Last commit `75728c1`.
> **Verified state:** backend **479/479**, frontend **125/125**, `verify-real-export` 16/16, `verify-real-publish` 4/4, visual baseline byte-identical, build + lint clean on both workspaces.
>
...
>
> ### Three live choices for the next session
> 1. **Sprint 9 Commit 4** — resume the approved UI plan.
> 2. **Persistence spike** — answer Question 6, unblock Sprint 11 (Workspace).
> 3. **Wire `Project` into the import pipeline** — make the app actually create projects.
>
> ### Open, unresolved, and worth not forgetting
> - **ADR-0038** (OPEN) — real pagination metrics never reach `PageCountRule`.
...
> - **Deletion semantics** — deleting a project destroys the record of real publications. Flagged in `ProjectRepository`, unanswered.
