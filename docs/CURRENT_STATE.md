...
**Branch:** `main`, at `02c3fd5` (this docs-sync commit, following immediately on top of the merge), tag `v0.8.0-alpha`. No active feature branch.
...
**Open branches:** none — `feature/sprint-7-first-demonstrable-product` deleted (local + remote) after PR #12 merged.
