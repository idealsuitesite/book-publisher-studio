...
**Branch:** `feature/sprint-7-first-demonstrable-product`, 3 commits ahead of `main` (`main` at `31b3139`, tag `v0.7.0-alpha`).
...
**Branch:** `feature/sprint-7-first-demonstrable-product`, at `583522c` (Commit 1: npm workspace + `packages/shared-types` scaffold, ADR-0033), branched from `main` at `31b3139`. `main` itself is at `31b3139`, tag `v0.7.0-alpha` (on an earlier commit, `eb05beb` — `main` has moved on with docs-only commits since).
...
**`feature/sprint-7-first-demonstrable-product` history:** `583522c` (Commit 1 — npm workspace conversion, `packages/shared-types` scaffold, ADR-0033) → branched from `main` at `31b3139`.
