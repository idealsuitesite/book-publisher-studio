...
| v0.3.0-alpha | Rendering Engine | 📐 Design Review complete, implementation not started | — | Theme Engine, Layout Engine, `Renderer` port, DOCX export — the Sprint 2 scope in `docs/TODO.md`. Design docs: ADR-0012–0017 (all APPROVED except ADR-0015, EPUB spike still open), `docs/architecture/diagrams/RENDERING_PIPELINE.md`. |
