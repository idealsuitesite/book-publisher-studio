...
| v0.4.1-alpha | EPUB Export | ⏳ Planned | — | EPUB library spike + ADR-0015 resolution (`epub-gen` vs. hand-rolled OCF/OPF/XHTML via `jszip`) first, then `EPUBRenderer` — Sprint 3B scope. |
