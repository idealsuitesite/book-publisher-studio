...
5. **Real fixtures over synthetic ones** — for import, pagination, TOC, renderer, and publishing changes, verify against a real manuscript, not only hand-built test objects. This project has shipped seven real bugs that passed 100% synthetic-fixture coverage (ADR-0019, ADR-0020, ADR-0031, IMPORT_FIDELITY commit 3, RENDER_DRIFT, the ADR-0051 annex — full lineage in the policy doc). → `docs/REAL_FIXTURE_POLICY.md`
