...
**Date:** 2026-07-18 (round 1) / 2026-07-18 (round 2 decisions) / 2026-07-18 (approved) / 2026-07-18 (Decision 7 added, Commit 1 authorized) / 2026-07-18 (Decision 8 added, Commit 2 authorized)
...
3. **Commit 2 — `Packaging` + `PublishingBundle`/`PublishingBundleManifest`** (assembles book + cover + metadata into a generic `PublishingBundle` — `{manuscript, cover, metadata, assets, manifest}`, zero KDP knowledge, per Decision 8/ADR-0037)
