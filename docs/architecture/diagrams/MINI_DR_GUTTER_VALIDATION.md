...
**Status:** APPROVED-BY-DELEGATION (CTO queue directive 2026-07-21: technical items with no taste decision proceed through the full cycle autonomously; the standing CTO decision scoping this chantier — `GUTTER_SCOPE.md` §4 **option 1 ONLY**, no renderer change — was taken explicitly and is not reopened here). Report at closure.
**Date:** 2026-07-22.
