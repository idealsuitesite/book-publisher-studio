...
**Next: Commit 6 (`feat(frontend): book structure view`)** — render `BookDTO.mainContent`, metadata, word/page/reading-time counters, replacing the minimal "Import complete" confirmation with the real structure.
